...
Pydantic implementation for the GitHub (FastAPI) service. The wire format is
identical across all six services. GitHub is the ``development`` category: its
"problems solved" is total commits, topic analysis is top languages, and it has
no contests / rating / badges.
"""
